...
// a shorter version of console.log using a rest parameter... little less to write
//allowing for infinite number of arguments
...
l(circle.x, circle.y, circle.z);
l(circle.getPosition());
l(circle.getSize());
